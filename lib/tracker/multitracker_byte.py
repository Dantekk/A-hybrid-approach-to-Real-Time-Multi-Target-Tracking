...
class Byte_JDETracker(object):
    def __init__(self, opt, frame_rate=30):
        ...
        self.model = load_model(self.model, opt.load_model, demo=opt.demo)
    ...
    def update_with_optical_flow(self, ):
        ...
        #print("*** UPDATE WITH OPTICAL FLOW ***")
    ...
    def update(self, im_blob, img0):
        ...
        ########
        #print("--- First association time %s seconds ---" % (time.time() - start_time))
        #######
        ...
        # get actual id of bbox [track.track_id for track in activated_starcks]
        '''
        print([track.track_id for track in activated_starcks])
        print(output_stracks)
        print(output_stracks[0].track_id)
        for x in output_stracks:
            print(x)
        '''
